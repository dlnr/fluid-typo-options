  ...
  <>
    <Styled.HeadingAndIntroContainer style={{ marginTop: '80px' }}>
      ...
      <Styled.Intro>
        ...
        procent van de stemmen kreeg. Paragraph large text level 5
      </Styled.Intro>
    </Styled.HeadingAndIntroContainer>
    <Styled.TextContainer>
      <Styled.Heading2>
        Voorlopige uitslag Provinciale - heading 2 text level 3
      </Styled.Heading2>
      <Styled.Paragraph>
        ...
        SGP en CU verliezen. Paragraph text level 7
      </Styled.Paragraph>
      <Styled.Heading3>
        Voorlopige uitslag Provinciale - heading 3 text level 4
      </Styled.Heading3>
      <Styled.Paragraph>
        ...
        Volt juist kiezers winnen. Paragraph text level 7
      </Styled.Paragraph>
      <Styled.Heading4>
        Voorlopige uitslag Provinciale - heading 4 text level 6
      </Styled.Heading4>
      <Styled.Paragraph>
        Aan de linkerkant van het politiek spectrum zijn de verschuivingen veel
        minder groot. GroenLinks en PvdA blijven gezamenlijk ongeveer even
      ...
      <Styled.ParagraphSmall>
        Aan de linkerkant van het politiek spectrum zijn de verschuivingen veel
        minder groot. GroenLinks en PvdA blijven gezamenlijk ongeveer even
        groot. Paragraph small text level 8
      </Styled.ParagraphSmall>
      <Styled.Quote>
        Aan de linkerkant van het politiek spectrum zijn de verschuivingen veel
        minder groot. GroenLinks en PvdA blijven gezamenlijk ongeveer even
        groot. Quote text level 4
      </Styled.Quote>
    </Styled.TextContainer>
  </>
)
